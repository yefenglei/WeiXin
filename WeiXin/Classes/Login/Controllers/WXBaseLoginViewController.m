...
-(void)login{
    ...
    [WXXMPPTool sharedWXXMPPTool].registerOperation=NO;
    __weak typeof(self) selfVc=self;
    
    [[WXXMPPTool sharedWXXMPPTool] xmppUserLogin:^(XMPPResultType type) {
...
-(void)enterMainPage{
    // 更改用户的登录状态为YES
    [WXUserInfo sharedWXUserInfo].loginStatus=YES;
